...
<head>
  ...
  <title>Vidya Setu Workshop</title>
</head>
...
<body oncontextmenu="return false">
  ...
  <header>
    <marquee loop="alternet" scrollamount=20 behavior="scroll" direction="left">
      <p>ॐ भूर् भुवः स्वः। &nbsp;&nbsp;&nbsp; तत् सवितुर्वरेण्यं। &nbsp;&nbsp;&nbsp; भर्गो देवस्य धीमहि।
  ...
  <section class="home" id="home">
    ...
    <div class="content">
      <h2>Hi There,<br /> I'm VIDYA SETU <span>PROGRAM</span></h2>
    ...
    <div class="image">
      <img style="width: 100%; border-radius:10% " src="./kcmt.jpg" alt="">
    </div>
  </section>
  <!-- hero section ends -->
